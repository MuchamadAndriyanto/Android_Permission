package com.example.android_permission.latihan_4
...
import com.example.android_permission.databinding.ActivityCameraPermissionBinding
import java.io.File
...
class CameraPermission : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnTakePhoto.setOnClickListener {
            ...
            val providerFile = FileProvider.getUriForFile(this,"com.example.android_permission.latihan_4.CameraPermission.fileprovider", filePhoto)
